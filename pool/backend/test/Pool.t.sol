...
contract PoolTest is Test {
    ...
    // here we do "fuzzing"
    function test_ExpectEmit_SuccessfullContribute
    (uint96 _amount) public {
        vm.assume(_amount > 0);
    ...
    function test_RevertWhen_WithdrawFailedToSendEther() 
    public{
        pool = new Pool(duration, goal);
    ...
    function test_RevertWhen_CollectNotFinished()
    public {
        vm.prank(addr1);
        vm.deal(addr1, 6 ether);
        pool.contribute{value: 6 ether}();
    ...
    function test_RevertWhen_GoalAlreadyReached()
    public {
        vm.prank(addr1);
        vm.deal(addr1, 6 ether);
        pool.contribute{value: 6 ether}();
    ...
    function test_RevertWhen_NoContribution() 
    public {
        vm.prank(addr1);
        vm.deal(addr1, 6 ether);
        pool.contribute{value: 6 ether}();
    ...
    function test_RevertWhen_RefundFailedToSendEther()
    public{
